    ...
    <div class="container-fluid" style="height: 100vh">
     <nav class="main-menu position-fixed ">
      ...
      <section class="section section-top section-full">
        ...
        <div
          class="bg-cover"
          style="background-image: url('/images/landing/landing4.jpg');
            position: absolute;
            top: 0;
            bottom: 0;
            left: 0;
...
<!----------------------------------------------------------------여행지 추천 섹션------------------------------------------------------------------>
      ...
      <div class="row mt-4">
        <div class="col-md-3">
          <div class="card mb-3 border-0 shadow ">
            <img
              src="/images/best-theme/busan.jpg"
        ...
        <div class="col-md-3">
          <div class="card mb-3 border-0 shadow ">
            <img
              src=" /images/best-theme/seoul.jpg"
              class="card-img-top rounded"
              alt="..."
            />
            <div class="card-body">
        ...
        <div class="col-md-3">
            <div class="card mb-3 border-0 shadow ">
              <img
                src=" /images/best-theme/suwon.jpg"
                class="card-img-top rounded"
                alt="..."
              />
              <div class="card-body">
        ...
        <div class="col-md-3">
          <div class="card mb-3 border-0 shadow ">
            <img
              src=" /images/best-theme/jeju3.jpg"
              class="card-img-top rounded"
              alt="..."
            />
            <div class="card-body">
    ...
    <div class="row mt-4">
      <div class="col-md-3">
          <div class="card mb-3 border-0 shadow ">
            <img
            src=" /images/best-theme/midnightseoul.jpg"
            class="card-img-top rounded"
            alt="..."
            />
            <div class="card-body">
        ...
        <div class="col-md-3">
          <div class="card mb-3 border-0 shadow ">
            <img
            src=" /images/best-theme/yangyang.jpg"
            class="card-img-top rounded"
            alt="..."
        ...
        <div class="col-md-3">
          <div class="card mb-3 border-0 shadow ">
              <img
              src=" /images/best-theme/yeosu.jpg"
              class="card-img-top rounded"
              alt="..."
              />
              <div class="card-body">
        ...
        <div class="col-md-3">
          <div class="card mb-3 border-0 shadow ">
            <img
            src=" /images/best-theme/terarosa.jpg"
            class="card-img-top rounded"
            alt="..."
            />
            <div class="card-body">
