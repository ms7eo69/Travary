    ...
    <div class="container-fluid" style="height: 100vh">
     <nav class="main-menu position-fixed ">
        <div class="outerDiv">
            <div class="innerDiv">
                <div id="nav-header">
                    <div class="logo">
                        <a href="#"><img src="<c:url value="/images/logo/logo.png"/>" class="nav-logo"></a>
                    </div>         
     ...
     <!----------------------------------------------네비게이션 끝-------------------------------------------> 
      ...
      <section class="section section-top section-full">
        <!-- Cover -->
        <div class="bg-cover" style="background-image: url('<c:url value="/images/landing/landing4.jpg"/>'); position: absolute;
            top: 0; bottom: 0; left: 0; right: 0; background-repeat: no-repeat; background-position: 100%; background-size: cover;">
        </div>
      ...
      <div class="row mt-4">
        <div class="col-md-3">
          <div class="card mb-3 border-0 shadow ">
            <img src="<c:url value="/images/best-theme/busan.jpg"/>" class="card-img-top rounded" alt="..."/>
            <div class="card-body">
        ...
        <div class="col-md-3">
          <div class="card mb-3 border-0 shadow ">
            <img src="<c:url value=" /images/best-theme/seoul.jpg"/>" class="card-img-top rounded" alt="..."/>
            <div class="card-body">
        ...
        <div class="col-md-3">
            <div class="card mb-3 border-0 shadow ">
              <img src="<c:url value=" /images/best-theme/suwon.jpg"/> " class="card-img-top rounded" alt="..."/>
              <div class="card-body">
        ...
        <div class="col-md-3">
          <div class="card mb-3 border-0 shadow ">
            <img src="<c:url value="/images/best-theme/jeju3.jpg"/> "class="card-img-top rounded" alt="..."/>
            <div class="card-body">
